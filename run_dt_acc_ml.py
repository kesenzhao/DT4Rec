...
from mingpt.model_acc import GPT, GPTConfig
...
user_retain=pd.read_csv('/content/gdrive/MyDrive/decision-transformer-master/atari/ml-1m/user_retain_seq_ml_week.csv')
...
done_idx_file=pd.read_csv('/content/gdrive/MyDrive/decision-transformer-master/atari/ml-1m/done_idx_seq_ml_week.csv')
done_idxs=done_idx_file['done_idx'].values
# print(len(done_idxs))
# de
action_seq=pd.read_csv('/content/gdrive/MyDrive/decision-transformer-master/atari/ml-1m/action_seq_ml_week.csv')
actions=action_seq['actions'].values.reshape(-1,20)
state_seq=pd.read_csv('/content/gdrive/MyDrive/decision-transformer-master/atari/ml-1m/state_seq_ml_week.csv')
obss=state_seq['obss'].values.reshape(-1,30)

action_seq_neg=pd.read_csv('/content/gdrive/MyDrive/decision-transformer-master/atari/ml-1m/action_seq_ml_week.csv')
...
action_seq_large=pd.read_csv('/content/gdrive/MyDrive/decision-transformer-master/atari/ml-1m/action_seq_ml_week.csv')
